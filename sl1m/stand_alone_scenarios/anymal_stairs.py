...
if __name__ == '__main__':
    ...
    anymal_rbprm_path = Path(anymal_rbprm.__file__).resolve().parent.parent.parent.parent.parent / "share" / "anymal-rbprm"
    paths = [str(anymal_rbprm_path / "com_inequalities" / "feet_quasi_flat" / "anymal_"),
